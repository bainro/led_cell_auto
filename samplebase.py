...
class SampleBase(object):
    def __init__(self, *args, **kwargs):
        ...
        self.parser.add_argument("--led-slowdown-gpio", action="store", help="Slow down writing to GPIO. Range: 1..100. Default: 1", choices=range(9), type=int)
        ...
        self.parser.add_argument("-l", "--loop", action="store_true", help="Loops the game")
